...
MyApp = (function () {
    ...
    function LoadProducts() {
        ...
        var settings = {
            type: "POST",
            dataType: "json",
            url: "/Product2/GetProductByUserId",
            data: d,
        ...
        MyAppGlobal.MakeAjaxCall("GET", 'Product2/GetProductByUserId', {}, function (resp) {
    ...
    function BindEvents() {
        ...
        $(".editprod").unbind("click").bind("click", function () {
            ...
            MyAppGlobal.MakeAjaxCall("GET", 'Product2/GetProductByUserId', d, function (resp) {
